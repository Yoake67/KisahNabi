...
class NabiIshaqActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_nabi_ishaq)
        ...
        val buttonSebelumnya: Button = findViewById(R.id.sebelumnyake8)
        ...
        val buttonSelanjutnya: Button = findViewById(R.id.selanjutnyake10)
